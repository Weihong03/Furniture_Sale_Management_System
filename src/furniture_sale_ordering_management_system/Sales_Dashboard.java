...
public class Sales_Dashboard extends javax.swing.JFrame {
    ...
    private void init() {
        ...
        lineChart.addData(new ModelChart("January", new double[]{190, 280, 81}));
        lineChart.addData(new ModelChart("February", new double[]{350, 540, 300}));
        lineChart.addData(new ModelChart("March", new double[]{480, 150, 750}));
        lineChart.addData(new ModelChart("April", new double[]{200, 350, 460}));
        lineChart.addData(new ModelChart("May", new double[]{600, 750, 90}));
        lineChart.addData(new ModelChart("June", new double[]{500, 200, 80}));
        lineChart.start();
        progress1.start();
        progress2.start();
        progress3.start();
